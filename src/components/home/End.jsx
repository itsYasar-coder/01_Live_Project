...
const End = () => {
  return (
    ...
    <div
  className=" w-[300px] h-[330px] ml-17 rounded-3xl bg-white/5 backdrop-blur-2xl border border-white/10 shadow-xl p-8 flex flex-col justify-between">
    ...
    <p className="flex items-center gap-2">
      ...
      <div className="  w-[300px] h-[330px] rounded-3xl bg-white/5 backdrop-blur-2xl border border-white/10 shadow-xl p-8 flex flex-col justify-between">
        ...
        <p className="text-sm text-gray-400 leading-relaxed mb-6">
          ...
          <br />
          reslient workforce cultures.Aligning
          <br />
          your human capital with long-term
          <br />
          goals
          </p>
      </div>
...
<div className="w-[300px] h-[330px] rounded-3xl bg-white/5 backdrop-blur-2xl 
border border-white/10 shadow-xl p-8 flex flex-col">
  ...
  <div>
    ...
    <p className="text-sm text-gray-400 leading-relaxed h-[90px]">
      Seamless cross-border talent acquisition. We handle the complexities
      of international pairing so you can focus on growth.
    </p>
  </div>
